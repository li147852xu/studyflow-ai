...
def main() -> None:
    ...
    if selected_paper:
        ...
        if st.button("Save Metadata", help="Update title/authors/year/tags."):
            update_paper_metadata(
        ...
        if st.button(
            ...
            try:
                ...
                add_history(
                    ...
                    summary=f"Paper card for {selected_paper['title']}",
                    preview=output.content[:200],
                    source_ref=selected_paper["doc_id"],
    ...
    if papers:
        ...
        if st.button(
            "Run Aggregation",
            disabled=not ready or not selected_titles,
            help=reason or "Aggregate selected papers.",
        ):
            if not selected_titles:
                ...
                try:
                    ...
                    add_history(
                        ...
                        summary=f"Aggregation ({len(doc_ids)} papers)",
                        preview=output.content[:200],
